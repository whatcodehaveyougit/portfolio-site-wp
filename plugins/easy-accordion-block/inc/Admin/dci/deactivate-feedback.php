...
if ( ! function_exists( 'dci_deactivate_feedback' ) ) {
	function dci_deactivate_feedback( $data ) {
			...
			<div class="dci-feedback-card">
				...
				<form method="get" class="dci-notice-data">
					...
					<div class="dci-feedback-tabs">
						<div class="dci-checkbox-group">
							<div class="dci-checkbox">
								<label class="dci-checkbox-wrapper">
									<input type="checkbox" class="dci-checkbox-input" name="switching-domain" />
									<span class="dci-checkbox-tile">
										<span class="dci-checkbox-icon">
							...
							<div class="dci-checkbox">
								<label class="dci-checkbox-wrapper">
									<input type="checkbox" class="dci-checkbox-input" name="couldnt-understand" />
									<span class="dci-checkbox-tile">
										<span class="dci-checkbox-icon">
							...
							<div class="dci-checkbox">
								<label class="dci-checkbox-wrapper">
									<input type="checkbox" class="dci-checkbox-input" name="found-a-better-plugin" />
									<span class="dci-checkbox-tile">
										<span class="dci-checkbox-icon">
		...
		c12.322-12.327,12.322-32.307-0.005-44.634L1579.829,1125.662z" />
							...
							<div class="dci-checkbox">
								<label class="dci-checkbox-wrapper">
									<input type="checkbox" class="dci-checkbox-input" name="missing-a-specific-feature" />
									<span class="dci-checkbox-tile">
										<span class="dci-checkbox-icon">
	...
	C499.5,480.7,531.3,438.3,499.5,385.4z M298.4,438.3h-84.7v-84.7h84.7V438.3z M298.4,311.3h-84.7V120.7h84.7V311.3z" />
							...
							<div class="dci-checkbox">
								<label class="dci-checkbox-wrapper">
									<input type="checkbox" class="dci-checkbox-input" name="not-working" />
									<span class="dci-checkbox-tile">
										<span class="dci-checkbox-icon">
		...
		C442.303,271.102,426.367,287.057,406.663,287.057z" />
										...
										<span
											class="dci-checkbox-label"><?php esc_html_e( 'Not working', 'data-collector-insights' ); ?></span>
									</span>
								</label>
							</div>
							<div class="dci-checkbox">
								<label class="dci-checkbox-wrapper">
									<input type="checkbox" class="dci-checkbox-input" name="others" />
									<span class="dci-checkbox-tile">
										<span class="dci-checkbox-icon">
										...
										<span
											class="dci-checkbox-label"><?php esc_html_e( 'Others', 'data-collector-insights' ); ?></span>
									</span>
								</label>
							</div>
						</div>
